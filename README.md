...
- **Amplifying crafting rings** — gaia-style loops (4 spirits → ingot → 12 spirits) and their whole family: byproduct intermediates, external-fuel rings, byproduct-rooted orders and coupled ring chains are solved algebraically (least fixed point, closure-checked) and folded into one bundle; startup working capital is reported exactly
