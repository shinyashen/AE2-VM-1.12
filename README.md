...
- **Amplifying crafting rings** — net-growing circular recipes are solved to material-minimal counts and folded into one executable plan, with exact startup-capital disclosure ([shapes & honest scope in the wiki](https://github.com/shinyashen/AE2-VM-1.12/wiki/Features#amplifying-crafting-rings-net-growing-loops))
